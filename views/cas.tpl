						...
						<div class="row">
							<div>
								...
								<!-- Text -->
								    ...
								    <!-- Izira stolpcov -->
									<form method="POST" action="/izpis_cas", name="izpis_nekateri">
                                        ...
                                        <dl class="row gtr-uniform">
                                            ...
                                            <dt class="col-3 col-12-small">
                                                <!-- od -->
                                                <div>
                                                <input type="date" name="od" id="od" value="" placeholder="Od kdaj"/>
												</div>
                                                <br>
                                                <!-- do -->
                                                <div>
                                                <input type="date" name="do" id="do" value="" placeholder="Do kdaj"/>
												</div>
                                                <br>
                                                <!-- id -->
                                                <div>
                                                ...
                                                <br>
                                                <!-- skladisce -->
												<input type="checkbox" id="skladisce" name="skladisce">
												<label for="skladisce">Skladišče</label>
                                                <br>
                                                <!-- teza -->
